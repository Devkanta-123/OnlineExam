...
<!-- Mirrored from kodeforest.net/html/uoe/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Feb 2024 09:16:41 GMT -->
...
<body>
	...
	<div class="kode_wrapper">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						<div class="user-box">
							...
							<div class="form">
								<div class="input-container">
									<input type="text" placeholder="Registration No" id="LoginRegistrationNo"
										name="LoginRegistrationNo">
		...
		<!-- STUDENT LOGIN MODEL END -->




		<!-- STUDENT REGISTER MODEL START -->
		...
		<!-- EXAMINER LOGIN MODEL START -->
		<div class="modal fade" id="examinerlogin-modal" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
						aria-hidden="true">&times;</span></button>
				<div class="modal-content">
					<div class="user-box">
						...
						<div class="form">
							...
							<div class="input-container">
								<button class="btn-style">Log In</button>
							</div>
						</div>
						<!--FORM FIELD END-->
						<!--OPTION START-->
		...
		<!-- EXAMINER LOGIN MODEL END -->



		<!-- ADMINISTRATOR LOGIN MODEL START -->
		<div class="modal fade" id="administratorlogin-modal" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
						aria-hidden="true">&times;</span></button>
				<div class="modal-content">
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<ul class="login_wrap">
								...
								<li><a href="#" data-toggle="modal" data-target="#signin-box"><i
											class="fa fa-users"></i> Students Login</a></li>
								<li><a href="#" data-toggle="modal" data-target="#studentRegister"><i
											class="fa fa-users"></i> Students Register</a></li>
								<li><a href="#" data-toggle="modal" data-target="#examinerlogin-modal"><i
											class="fa fa-users"></i>Examiner Login</a></li>
								<li><a href="#" data-toggle="modal" data-target="#administratorlogin-modal"><i
											class="fa fa-users"></i>Administrator Login</a></li>
							</ul>
							<!-- <ul class="top_nav">
								...
								<div class="kf_cur_catg_wrap">
									...
									<div class="col-md-6">
										<div class="kf_cur_catg_des color-1">
											...
											<div class="kf_cur_catg_capstion">
												<h5>Business</h5>
												<p>Business Trends changing with latest courses are available with us.
												</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="kf_cur_catg_des color-2">
											...
											<div class="kf_cur_catg_capstion">
												<h5>Accounting</h5>
												<p>Accounting need to be perfect. Come and join with us with best
													resources.</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="kf_cur_catg_des color-3">
											...
											<div class="kf_cur_catg_capstion">
												...
												<p>Latest technologies online courses are available with new courses.
												</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="kf_cur_catg_des color-4">
											...
											<div class="kf_cur_catg_capstion">
												...
												<p>Learn about the Health & Psychology with the complete presentation.
												</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="kf_cur_catg_des color-5">
											...
											<div class="kf_cur_catg_capstion">
												<h5>Food & Drinking</h5>
												<p>Get the best eating education and practice by taking online courses.
												</p>
											</div>
										</div>
									</div>
				...
				<div class="kf_intro_des_wrap">
					...
					<div class="kf_intro_des">
						<div class="kf_intro_des_caption">
							...
							<h6>BOOKS & LIBRARY</h6>
							<p>World Largest books and library center is here where you can study the latest trends of
								the education.</p>
							<a href="#">view more</a>
						</div>
						<figure>
						...
						<div class="col-md-8">
							<div class="kf_edu2_tab_wrap">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a href="#accounting" aria-controls="accounting" role="tab"
									...
									<li role="presentation"><a href="#finance" aria-controls="finance" role="tab"
											data-toggle="tab">Finance</a></li>
									<li role="presentation"><a href="#technologies" aria-controls="technologies"
											role="tab" data-toggle="tab">Technologies</a></li>
											...
											<div class="col-md-4">
												<div class="edu2_cur_wrap">
													<figure>
														...
														<figcaption><a href="courses-detail.html">See More</a>
														</figcaption>
													</figure>
													<div class="edu2_cur_des">
														...
														<p>If you want to build a successful business online, watch the
															promo video to see why 13,000+ students are using this
															online entrepreneurship course to learn.</p>
													</div>
												...
												<div class="edu2_cur_wrap">
													...
													<div class="edu2_cur_des">
														...
														<p>Personal time management skills are essential for
															professional & personal success in any area of life. Those
															able to successfully implement time management strategies
														</p>
													</div>
													<div class="edu2_cur_des_ft">
														<figure>
											...
											<div class="col-md-4">
												<div class="edu2_cur_wrap">
													...
													<div class="edu2_cur_des">
														...
														<p>Welcome to Logo Design fundamentals of building a great brand
															Logo. Our course teacher Lauren, walks you through his
															process of logo design.</p>
													</div>
													<div class="edu2_cur_des_ft">
														<figure>
						...
						<div class="filterable-item all 2 1 9 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery1.jpg"><i
												class="fa fa-eye"></i></a>
						...
						<div class="filterable-item all 3 2 1 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery2.jpg"><i
												class="fa fa-eye"></i></a>
										<a href="#"><i class="fa fa-link"></i></a>
										<h5>Lorem Ipsum Proin</h5>
										<p>Convocation</p>
						...
						<div class="filterable-item all 4 2 9 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery3.jpg"><i
												class="fa fa-eye"></i></a>
										<a href="#"><i class="fa fa-link"></i></a>
										<h5>Lorem Ipsum Proin</h5>
										<p>Convocation</p>
						...
						<div class="filterable-item all 9 8 7 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery4.jpg"><i
												class="fa fa-eye"></i></a>
										<a href="#"><i class="fa fa-link"></i></a>
										<h5>Lorem Ipsum Proin</h5>
										<p>Convocation</p>
						...
						<div class="filterable-item all 3 2 4 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery5.jpg"><i
												class="fa fa-eye"></i></a>
										<a href="#"><i class="fa fa-link"></i></a>
										<h5>Lorem Ipsum Proin</h5>
										<p>Convocation</p>
						...
						<div class="filterable-item all 4 5 7 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery6.jpg"><i
												class="fa fa-eye"></i></a>
										<a href="#"><i class="fa fa-link"></i></a>
										<h5>Lorem Ipsum Proin</h5>
										<p>Convocation</p>
						...
						<div class="filterable-item all 3 5 7 9 col-md-3 col-sm-4 col-xs-12 no_padding">
							<div class="edu2_gallery_des">
								<figure>
									...
									<figcaption>
										<a data-rel="prettyPhoto[gallery2]" href="extra-images/home-gallery7.jpg"><i
												class="fa fa-eye"></i></a>
										<a href="#"><i class="fa fa-link"></i></a>
										<h5>Lorem Ipsum Proin</h5>
										<p>Convocation</p>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-6 thumb">
										<figure><img src="extra-images/news1.jpg" alt="" />
											<figcaption><a href="blog-detail.html"><i class="fa fa-plus"></i></a>
											</figcaption>
										</figure>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="edu2_pricing_des">
									<h4>Trial</h4>
									<div class="pckg-price"><strong><sup></sup>Free</strong>
										<h3>30 Days</h3>
									</div>
									<ul>
							...
							<div class="col-md-4">
								...
								<div class="edu2_pricing_des">
									<h4>Silver</h4>
									<div class="pckg-price"><strong><sup>$</sup>149</strong>
										<h3>30 Days</h3>
									</div>
									<ul>
										<li><a href="#">300+ Audio Lesson mp3s</a></li>
							...
							<div class="col-md-4">
								...
								<div class="edu2_pricing_des">
									<h4>Gold</h4>
									<div class="pckg-price"><strong><sup>$</sup>299</strong>
										<h3>30 Days</h3>
									</div>
									<ul>
										<li><a href="#">300+ Audio Lesson mp3s</a></li>
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#StudentRegsiterbtn').click(function () {
				...
				$.ajax({
					url: 'studentregisterbackend.php',
					type: 'POST',
					data: {
...
<!-- Mirrored from kodeforest.net/html/uoe/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Feb 2024 09:17:19 GMT -->
